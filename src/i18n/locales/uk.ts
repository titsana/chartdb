    ...
    translation: {
        ...
        menu: {
            ...
            backup: {
                ...
                add_to_current_diagram: 'Додати до поточної діаграми',
            },
            help: {
                help: 'Довідка',
        ...
        import_diagram_dialog: {
            ...
            title_current: 'Додати до поточної діаграми',
            description_current:
                'Додати одну або декілька діаграм з файлів JSON до поточної діаграми.',
            cancel: 'Скасувати',
            import: 'Імпортувати',
            error: {
